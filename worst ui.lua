...
library.theme = {
    ...
    tilesize = 90,
    cursor = false,
    cursorimg = "https://i.pinimg.com/originals/df/5e/5f/*image*",
    backgroundcolor = Color3.fromRGB(20, 20, 20),
    tabstextcolor = Color3.fromRGB(255, 18, 89),
    bordercolor = Color3.fromRGB(60, 60, 60),
    accentcolor = Color3.fromRGB(28, 56, 139),
    accentcolor2 = Color3.fromRGB(16, 31, 78),
    outlinecolor = Color3.fromRGB(255, 31, 68),
    outlinecolor2 = Color3.fromRGB(0, 0, 0),
    sectorcolor = Color3.fromRGB(255, 18, 89),
...
function library:CreateWindow(name, size, hidebutton)
    ...
    function window:CreateTab(name)
        ...
        function tab:CreateConfigSystem(side)
            ...
            configSystem.configFolder = "FedoraWare"
