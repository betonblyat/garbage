...
-- Setup:
Luazifier = {} 
setmetatable(Luazifier, {__metatable = "pastenamehere"})
...
Luazifier.ScreenGui1.Name = "test1"
...
Luazifier.ImageLabel1.Name = "test3"
...
Luazifier.TextLabel1.Name = "test5"
...
Luazifier.TextLabel1.Text = "test6"
...
Luazifier.TextLabel2.Name = "test8"
...
Luazifier.TextLabel2.Text = "test9"
...
local Flag = getByName("test10")
local LeftSideText = getByName("hi")
local RightSideText = getByName("buddy")
