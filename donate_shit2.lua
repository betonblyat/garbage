...
queueonteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/betonblyat/garbage/main/donate_shit2.1.lua'))()")
...
webhookTab:AddButton("Test Message", function()
    if getgenv().settings.webhookBox then
        webhook("@here ur ip address and password's successfully stolen! enjoy!")
    end
end)
...
Players.LocalPlayer.leaderstats.Raised.Changed:Connect(function()
    ...
    if getgenv().settings.webhookToggle and getgenv().settings.webhookBox then
        ...
        if string.find(logs[#logs].message, Players.LocalPlayer.DisplayName) then
            ...
            webhook(tostring(" [🤑] Somebody tipped! 🤯 @everyone ".. Players.LocalPlayer.leaderstats.Raised.value - RaisedC.. " Robux to ".. Players.LocalPlayer.DisplayName.. " (Total: " .. Players.LocalPlayer.leaderstats.Raised.value.. ")"))
        end
    end
